...
def verificar_quadrados_secretos(matriz_secreta):
    ...
    for i in range(dimensao):
        for j in range(dimensao):
            if matriz[i][j] == 1 and matriz_secreta != "-":
                matriz_secreta[i][j] = 1
            else:
                if matriz[i][j] == 2 and matriz_secreta != "-":
                    matriz_secreta[i][j] = 2
                else:
                    if matriz[i][j] == 3 and matriz_secreta != "-":
                        matriz_secreta[i][j] = 3
                        ...
                        if matriz[linha][coluna] == " ":
                            ...
                            if matriz[linha][coluna] == "@":
                                ...
                                if matriz[linha][coluna] == "-":
                                    ...
                                    verificar_quadrados_secretos(matriz_secreta)
                ...
                while escolha == 2:
                    ...
                    if linha < 0 or linha > 9 or coluna < 0 or coluna > 9:
                        ...
                        if matriz[linha][coluna] == "@":
                            ...
                            matriz_secreta[linha][coluna] = "⚐"
                            #exibir_matriz(matriz)
                            exibir_matriz(matriz_secreta)
                            print("Você marcou uma mina!")
                            if minas_marcadas == tamanho:
            ...
            if escolha == 3:
                while escolha == 3:
                    ...
                    if linha < 0 or linha > 9 or coluna < 0 or coluna > 9:
                        ...
                        if matriz_secreta[linha][coluna] != "⚐":
                            ...
                            if matriz[linha][coluna] == "@":
                                ...
                                #exibir_matriz(matriz)
                                exibir_matriz(matriz_secreta)
                                print("Você desmarcou uma casa certa!")
                                menu()
                                escolha = int(input("Escolha o que quer fazer: "))
                            else:
                                matriz_secreta[linha][coluna] = "-"
...
print("Escolha de 1 até 7!")
tamanho = int(input("Quantas minas você deseja jogar? "))
while tamanho < 1 or tamanho > 7:
    print("Escolha de 1 até 7!")
    tamanho = int(input("Quantas minas você deseja jogar? "))
else:
